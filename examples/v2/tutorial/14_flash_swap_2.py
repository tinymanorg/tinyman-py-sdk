...
from tinyman.v2.formulas import calculate_flash_swap_asset_1_payment_amount
...
asset_2_payment_amount = 0
asset_1_payment_amount = calculate_flash_swap_asset_1_payment_amount(
